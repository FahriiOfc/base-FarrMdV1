...
/**
 * messageContextInfo.supportPayload value WhatsApp expects on bot/AI-labelled
 * messages (send with `{ ai: true }`).
 */
...
/**
 * Minimal source-code lexer used to syntax-highlight `code` blocks
 * inside richResponseMessage. Capture groups:
 *  1: comment · 2: string · 3: function-ish identifier · 4: identifier ·
 *  5: number · 6: whitespace/symbol
 */
...
export { KEY_BUNDLE_TYPE } from '../Utils/crypto-constants.js';
