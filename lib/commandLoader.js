...
import commandManager from './commandManager.js'; // ✅ TAMBAHKAN
...
export class CommandLoader {
    ...
    async #loadCommandFile(filePath) {
        try {
            ...
            // Set default flags jika tidak ada
    ...
    // ============================================================
    // GET ALL COMMANDS WITH DETAILS (untuk listcmd)
    // ============================================================
    ...
    // ============================================================
    // VALIDATION - UPDATED with AI Modules Support
    // ============================================================
    ...
    #validatePath(filePath) {
        ...
        // ✅ TAMBAHKAN AI-MODULES PATH
        const AI_MODULES_DIR = path.join(PROJECT_ROOT, 'ai-modules');

        // Harus di dalam command/ ATAU ai-modules/
        if (!fullPath.startsWith(COMMAND_DIR) && !fullPath.startsWith(AI_MODULES_DIR)) {
            throw new Error('Path must be inside command/ or ai-modules/ directory');
        }
