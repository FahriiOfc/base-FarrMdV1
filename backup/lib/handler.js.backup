// lib/handler.js
// Message Handler - Full Code with Listcmd, Getcmd, Mute, Hidetag Support
...
export class Handler {
    ...
    async handleMessage(message) {
        try {
            ...
            // ============================================================
            // MUTE CHECK - HAPUS PESAN DARI USER YANG DIMUTE
            // ============================================================
            ...
            if (jid.endsWith('@g.us') && !message.key.fromMe) {
                ...
                if (database.isMuted(jid, muteSender)) {
                    ...
                    // ⛔ LANGSUNG RETURN - JANGAN PROSES LEBIH LANJUT
                    return;
                }
            }
            ...
            // ============================================================
            // HANDLE LIST RESPONSE (INTERACTIVE LIST)
            // ============================================================
            ...
            // ============================================================
            // HANDLE BUTTON RESPONSE (LISTCMD & GETCMD)
            // ============================================================
            ...
            // CEK APAKAH SENDER DI-MUTE (TIDAK BISA PAKAI COMMAND)
            if (jid.endsWith('@g.us') && !message.key.fromMe) {
            ...
            // ============================================================
            // EXECUTE COMMAND - SUPPORT STRING ATAU OBJECT
            // ============================================================
            ...
            try {
                ...
                // CASE 2: Object response dengan text/mentions
                ...
                // CASE 3: Command sudah kirim sendiri (return void/undefined)
